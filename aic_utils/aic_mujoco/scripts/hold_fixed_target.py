...
Role:
  This is a full-scene visual/debug reference using regular MuJoCo
  ``scene.xml``. It validates frame math, reset IK, payload placement, and
  holding behavior. It is not the high-throughput MuJoCo Warp training loop.
